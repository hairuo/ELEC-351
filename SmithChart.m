...
z1 = [55.6-j*282; 3.23-j*42.1; 1.54-j*0.7; 1.68+j*25.8; 5.77+j*93; 71.9-j*298; 3.65-j*40; 9.4740 - 2.2323i];
gamma1 = (z1 - z0) ./ (z1 + z0);
...
z1 = [317 + 1i*736; 55.6-j*282; 3.23-j*42.1; 1.54-j*0.7; 1.68+j*25.8; 5.77+j*93; ...
      71.9-j*298; 3.65-j*40; 9.4740 - 2.2323i]; 
